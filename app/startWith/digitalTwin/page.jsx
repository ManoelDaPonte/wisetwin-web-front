	...
	return (
		<div className={styles.pageSections}>
			<div className={styles.section}>
				<h1 className="title">What is a Digital Twin?</h1>
				<div className="dark">
			...
			<div className={styles.section}>
				<h2 className="titleLight">How a Digital Twin Works</h2>
				<div className="light">
			...
			<div className={styles.section}>
				<h2 className="title">Benefits of Digital Twins</h2>
				<div className="dark">
					<ul>
						<li>
							<strong>Performance Improvement:</strong> By
							monitoring system performance in real-time, Digital
							Twins enable the optimization of operations and
							identification of inefficiencies.
						</li>
						<li>
							<strong>Predictive Maintenance:</strong> With
							predictive analytics, it is possible to foresee
							failures and schedule maintenance before problems
							occur, reducing downtime.
						</li>
						<li>
							<strong>Innovation and Testing:</strong> Companies
							can test new ideas or modifications in the digital
							model before applying them in the real world,
			...
			<div className={styles.section}>
				<h2 className="titleLight">Applications of Digital Twins</h2>
				<div className="light">
					<ul>
						<li>
						...
						<li>
							<strong>Aerospace:</strong> To monitor and maintain
							aircraft, increasing safety and efficiency.
						</li>
						<li>
							<strong>Healthcare:</strong> To create personalized
							models of human organs and improve diagnostics and
							treatments.
						</li>
						<li>
