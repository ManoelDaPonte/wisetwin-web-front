            ...
            <div className="flex flex-col items-center gap-6 pb-8 text-center">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 mt-6">
                ...
                <div className="relative bg-white bg-opacity-10 backdrop-blur-lg p-2 sm:p-4 md:p-6 rounded-lg text-sm sm:text-base">
                  ...
                  <p className="text-white text-sm">Customize your twin and virtualize your plant, from pilot to industrial scale</p>
                </div>

                <div className="relative bg-white bg-opacity-10 backdrop-blur-lg p-2 sm:p-4 md:p-6 rounded-lg text-sm sm:text-base">
                  <h2 className="text-base font-semibold text-white">100% Integration</h2>
                  <p className="text-white text-sm">Get a full digital copy of your industry by cross-platform integrations</p>
                </div>
              </div>
