import styles from "@/styles/calculatorPage/calculatorForm.module.css";
...
export default function calculatorForm() {
	...
	async function handleSubmit(event) {
		...
		const response = await fetch("/api/sendMailCalculator", {
			method: "POST",
			body: formData,
		});
	...
	return (
		<div className={styles.formContainer}>
			<div className={styles.title}>How much would it cost you to get your first digital twin? </div>
			<div className={styles.subtitle}>
				We desgined a calculator that evaluates the cost of your digital twin.
			</div>
