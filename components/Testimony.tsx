...
const testimonials = [
	...
	},
	{
		...
		description: (
			<p>
				...
				<Highlight>Our development speed has doubled.</Highlight>{" "}
	...
	},
	{
		...
		description: (
			<p>
				Leveraging #DataCrunch's AI for our financial models has given
				us an edge in predictive accuracy.
				<Highlight>
	...
	},
	{
		...
		description: (
			<p>
				By integrating #GreenTech's sustainable energy solutions, we've
				seen a significant reduction in carbon footprint.
				<Highlight>
	...
	},
	{
		...
		description: (
			<p>
				...
				<Highlight>
					Technology and healthcare working hand in hand for better
					health.
				</Highlight>{" "}
