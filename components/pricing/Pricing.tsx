...
const demoPrices = [
  {
    ...
    description: "Designed for Start-ups/SME from Proof of Concepts to Pilot plants",
    features: [
  ...
  },
  {
    ...
    description: "Designed for large scale plants, integrable with your architecture",
    features: [
...
export default function Pricing() {
  const [interval, setInterval] = useState<Interval>("Startup - SME");
  ...
  const handleToggle = () => {
    setInterval((prevInterval) =>
      prevInterval === "Startup - SME" ? "Industry - Enterprise" : "Startup - SME"
    );
  };

  return (
    <section id="pricing" className="mx-auto flex max-w-screen-xl flex-col gap-8 px-4 py-14 md:px-8">
        ...
        <div className="mt-6 flex items-center justify-center">
          <div className="relative flex items-center bg-neutral-200 rounded-full w-64 p-3 cursor-pointer">
            ...
            <div
              ...
              className={`relative z-10 w-1/2 text-center text-sm font-medium ${
                interval === "Industry - Enterprise" ? "text-white" : "text-black"
              }`}
            >
              Enterprise
            </div>
      ...
      <div className="mx-auto flex flex-col sm:flex-row justify-center gap-8">
        <div className="flex flex-wrap justify-center gap-8 w-full sm:w-auto">
          {demoPrices
            .filter((price) =>
              interval === "Startup - SME" ? price.id === "price_1" : price.id === "price_2"
            )
            .map((price) => (
              <div key={price.id} className="flex items-center gap-6 w-full max-w-[500px]"> {/* Increase max width */}
                {/* Price Card */}
                <div
                ...
                >
                  <div className="flex items-center">
                    <div className="ml-4">
                      <h2 className="text-lg font-semibold leading-7">{price.name}</h2>
                  ...
                  <a href="/contact">
                    ...
                    >
                      ...
                      {(!isLoading || (isLoading && id !== price.id)) && <p>Get a FREE demo</p>}
